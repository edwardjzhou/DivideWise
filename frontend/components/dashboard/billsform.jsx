        ...
        return (
            <div className="addfriend-form"> <div id="formheader">Add an Expense</div>
                <form onSubmit={this.handleSubmit}>
                    <div style={{ height: `32px`, left: `20px`, borderBottom: `1px solid #EEEEEE`, width: `100%`, padding: `4px 4px 4px 4px`}}>
                ...
                <div style={{margin: `5px 33px 5px 33px`, position: 'relative', display:`flex` ,height:`200px` }}>  
                    <img src={window.check} style={{margin:'50px 16px 10px 0', display: `block`, verticalAlign:`middle`
                , padding: `0 0 0 0`, width: `64px`, height: `64px`}}></img>
                    
                        <div style={{display: `flexbox`, flexDirection: `column`, padding: `30px`}}>
                    
                            <input className="unfocus" onChange={this.update(`description`)} type='text' style={{
                                height: `50%`, width: `83%`, padding: `0px 0px 0px 0px`, display: `block`, 
                                    fontSize: `25px`,  boxShadow: `none`,
                                    border: `none`, borderBottom: `1px dashed #CCCCCC`}} placeholder='Enter a description'></input>
                            <div style={{display:`inline-block`, verticalAlign: `bottom`, position: `relative`}}>
                                ...
                                width: `80%`, padding: `4px 3px 2px 3px`, display: `inline-block`,
                ...
                {this.state.selfDebtor === false ?
                        <p className="centerme" onClick={()=>this.meTheDebtor()} style={{borderBottom: `1px solid #EEEEEE`}}> Paid by <span className='STRONG graycircle'>YOU</span><br/>(so he/she owes you ${this.state.amount ? this.state.amount : 0.00})</p>
                        :
                        <p className="centerme" onClick={() => this.theyTheDebtor()} style={{ borderBottom: `1px solid #EEEEEE` }}> Paid by <span className='STRONG graycircle' style={{width:`auto`}}>FRIEND</span><br/>(so you owe him/her ${this.state.amount ? this.state.amount : 0.00})</p>
                }
                    

                    <div style={{margin:`1vh`, display: `flex`, justifyContent:`flex-end`}}>
